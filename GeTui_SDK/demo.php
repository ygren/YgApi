...
define('APPKEY', 'mA1FrFqO5C9NjCIlbu1A49');
define('APPID', 'PgyRGa57S28MjhbXEWW4V8');
define('MASTERSECRET', 'XbHojuMUgk5r7gtrYaIyn4');
define('HOST', 'http://sdk.open.api.igexin.com/apiex.htm');
define('CID', '6199abf37fbd41c2e82bdd9338feb0a4');
define('DEVICETOKEN', '');
define('Alias', '请输入别名');
